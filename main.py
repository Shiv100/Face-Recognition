...
# load known faces
shiv_image = face_recognition.load_image_file("faces/shiv.png")
...
shubham_image = face_recognition.load_image_file("faces/shubham.png")
shubham_encoding = face_recognition.face_encodings(shubham_image)[0]

salman_image = face_recognition.load_image_file("faces/salman.jpeg")
salman_encoding = face_recognition.face_encodings(salman_image)[0]

known_face_encodings = [shiv_encoding,sumit_encoding,shubham_encoding, salman_encoding ]
known_face_names = ["Shiv", "Sumit", "Shubham", "Salman"]
...
while True:
    ...
    # Add the text if a pereson is present
